...
do
    ...
    # Define the URL
    url="https://github.com/gldeng/libbn254/releases/download/${LIB_VERSION}/libbn254-${platforms[index]}-${LIB_VERSION}.zip"

    # Define the target directory relative to the script directory
    dir="$script_dir/../Bn254.Net/native/${subfolders[index]}"
